...
#preprocessing and model information retrieved from: https://keras.io/api/applications/resnet/#resnet152v2-function
...
#predicting spikelet number on test set
results = model.predict(X_test)

#saving results in CSV file
np.savetxt("resnet152v2.csv", results, delimiter= ",") #CHANGE FILE NAME HERE

print(results)

#accuracy and loss for forward validation
test_loss, test_acc = model2.evaluate(X_test,  y_test, verbose=2)
print(f"test loss: {test_loss}")
print(f"test acc: {test_acc}")


#printing results in text file
file = open("resnet152v2_output.txt", "a") #CHANGE FILE NAME HERE
